...
#include <ldapcpp/LDAPConnectionVersion2ProtocolPolicy.hpp>

namespace ldapcpp {

LDAPConnectionVersion2ProtocolPolicy::LDAPConnectionVersion2ProtocolPolicy()
{
...
void LDAPConnectionVersion2ProtocolPolicy::setProtocolVersion(LDAP* ldap) {
	unsigned long version = LDAP_VERSION2;
